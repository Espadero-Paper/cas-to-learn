...
<html class="no-js">
    <head>
        <title>CAS2LEARN LMS</title>
		<meta name="description" content="Learning Management System">
		<meta name="keywords" content="CAS-BPA LMS,CASLMS,CAS,LMS">
		<meta name="author" content="John Alvin Ruz">
		<meta charset="UTF-8">
		<link rel="shortcut icon" href="admin/images/cas.png" type="image/x-icon"/>
        <!-- Bootstrap -->
