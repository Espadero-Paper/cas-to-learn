        ...
        <div class="container-fluid">
			...
			<form action="read_message.php" method="post">
										<div class="pull-right">
											<button class="" name="read"><i class="icon-check"></i> Read</button>
							...
							Check All <input type="checkbox"  name="selectAll" id="checkAll" />
								...
								$("#checkAll").click(function () {
									$('input:checkbox').not(this).prop('checked', this.checked);
										...
										<li class=""><a style="color:red;" href="student_message.php"><i class="icon-envelope-alt"></i>inbox</a></li>
										<li class=""><a style="color:red;" href="sent_message_student.php"><i class="icon-envelope-alt"></i>Send messages</a></li>
										</ul>
								...
								<?php }}else{ ?>
								<div style="background-color:red;" class="alert alert-info"><i class="icon-info-sign"></i> No messages</div>
								<?php } ?>		
								</form>		
                                </div>
                            </div>
