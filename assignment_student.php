					   ...
					   <!-- breadcrumb -->
                        ...
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
								...
								?>
                                <div  id="" class="muted pull-right"><span style="background-color:red;" class="badge badge-info"><?php echo $count; ?></span></div>
                            </div>
                            <div class="block-content collapse in">
								...
								<?php
									...
									$count = mysqli_num_rows($query);
									if ($count == '0'){?>
									<div style="background-color:red;" class="alert alert-info">No Assignment Currently Uploaded</div>
									<?php
									}else{
								?>
