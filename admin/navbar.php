 <div class="navbar navbar-fixed-top navbar-inverse">
            <div class="navbar-inner">
                <div style="background-color:red;" class="container-fluid">
                    ...
                    <span class="brand" href="#">CAS2LEARN ADMIN Panel</span>
                    <div class="nav-collapse collapse">
						...
						?>
                            <li class="dropdown">
                                <a href="#" role="button" class="dropdown-toggle" data-toggle="dropdown"> <i class="icon-user icon-large"></i><?php $row['firstname']." ". $row['lastname'];  ?> <i class="caret"></i>
