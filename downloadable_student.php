                     ...
                     <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
                                <div  class="span12">
										<div style="color:white;margin-top:8px;margin-right:10px;" class="pull-right">
							Check All <input type="checkbox"  name="selectAll" id="checkAll" />
								...
								<?php
									...
									$count = mysqli_num_rows($query);	
								if ($count == '0'){ ?>
								<div style="background-color:red;" class="alert alert-info"><i class="icon-info-sign"></i> No downloadable material currently uploaded.</div>
								<?php
								}else{
								?>
